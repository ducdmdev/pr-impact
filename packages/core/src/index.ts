...
export { diffExports, diffExportsAsync, parseExports, parseExportsAsync } from './breaking/export-differ.js';
export type { FileResolver, ExportDiffResult } from './breaking/export-differ.js';
...
export { extractImportPaths, isRelativeImport, resolveImport, findConsumers, buildReverseDependencyMap } from './imports/import-resolver.js';
export type { ReverseDependencyMap } from './imports/import-resolver.js';
